...
import com.cow.pastelitocoffe.cow.pastelitocoffe.Security.ServiceSecurity.UserDetailsServiceImp;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private com.cow.pastelitocoffe.cow.pastelitocoffe.Security.Jwt.JwtUtils jwtUtils;
    @Autowired
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(StringUtils.hasText(token) && jwtUtils.validateToken(token)){
            ...
            if(roles.contains("USER") || roles.contains("ADMIN") || roles.contains("EMPLOYEE")){
